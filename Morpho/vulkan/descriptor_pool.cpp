...
bool DescriptorPool::try_allocate_set(const DescriptorSetLayout& layout, DescriptorSet& set) {
    if (allocated >= max_sets) {
        return false;
    }
    VkDescriptorSetLayout set_layout = layout.get_descriptor_set_layout();
